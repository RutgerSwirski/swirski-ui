...
export default function CodeBlock({ code, className = "" }: CodeBlockProps) {
  return (
    ...
    >
      <pre className="block max-h-164 w-full max-w-full overflow-auto whitespace-pre p-4 pr-18 text-xs font-bold leading-6 text-white sm:p-5 sm:pr-28 sm:text-sm sm:leading-7">
